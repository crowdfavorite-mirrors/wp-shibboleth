...
define ( 'SHIBBOLETH_PLUGIN_REVISION', preg_replace( '/\$Rev: (.+) \$/', '\\1',
	'$Rev: 282438 $') ); // this needs to be on a separate line so that svn:keywords can work its magic
...
function shibboleth_session_active() { 
	...
	$session_headers = array('Shib-Session-ID', 'Shib_Session_ID', 'Shib_Identity_Provider', 'HTTP_SHIB_IDENTITY_PROVIDER');
